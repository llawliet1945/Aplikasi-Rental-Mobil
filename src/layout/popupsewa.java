...
import layout.sewa;
public class popupsewa extends javax.swing.JFrame {
    private Connection conn = new connection().connect();
    private DefaultTableModel tabmode;
    public pengembalian sewa = null;
    public popupsewa() {
        initComponents();
        datatable();
    }
    ...
    private void tblSewaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSewaMouseClicked
        ...
        try {
            sewa.idsewa = tblSewa.getValueAt(tblnyewa, 0).toString();
            sewa.idmobil = tblSewa.getValueAt(tblnyewa, 1).toString();
            sewa.idpenyewa = tblSewa.getValueAt(tblnyewa, 2).toString();
            sewa.tgl = Date.valueOf(tblSewa.getValueAt(tblnyewa, 3).toString());
            sewa.sewaTerpilih();
        } catch (Exception ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popupsewa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
