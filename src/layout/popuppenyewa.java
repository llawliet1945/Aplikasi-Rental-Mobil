...
import layout.sewa;
public class popuppenyewa extends javax.swing.JFrame {
    private Connection conn = new connection().connect();
    private DefaultTableModel tabmode;
    public sewa nyewa = null;
    public popuppenyewa() {
        initComponents();
        datatable();
    }
    ...
    private void initComponents() {
        ...
        jScrollPane4.setViewportView(tblpenyewa);
    ...
    private void tblpenyewaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblpenyewaMouseClicked
        int tblnyewa = tblpenyewa.getSelectedRow();
        nyewa.idpenyewa = (String)tblpenyewa.getValueAt(tblnyewa, 0);
        nyewa.penyewaTerpilih();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popuppenyewa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popuppenyewa().setVisible(true);
            }
        });
    }
